...
export default function FooterSection() {
  return (
    <footer className="bg-zinc-900 text-white pt-14">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-10">
        <div>
      ...
      <div className="mt-10 border-t border-white/10">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 py-6 flex flex-col md:flex-row items-center justify-between text-white/70 text-sm gap-3">
